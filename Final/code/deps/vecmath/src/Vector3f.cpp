...
double Vector3f::getMAX() {
	if (m_elements[0] > m_elements[1])
		return (m_elements[0] > m_elements[2]) ? m_elements[0] : m_elements[2];
	return (m_elements[1] > m_elements[2]) ? m_elements[1] : m_elements[2];
}
